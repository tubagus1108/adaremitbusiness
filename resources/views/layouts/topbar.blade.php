            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        {{-- @case('id')
                            <img src="{{ URL::asset('/assets/images/flags/indonesia.svg') }}" class="me-2 rounded" alt="Header Language"
                                height="20">
                        @break --}}
                        @case('en')
                            <img src="{{ URL::asset('/assets/images/flags/us.svg') }}" class="me-2 rounded" alt="Header Language"
                                height="20">
                        @break
                        @default
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        {{-- <a href="{{ url('id') }}" class="dropdown-item notify-item language py-2" data-lang="en"
                            title="English">
                            <img src="{{ URL::asset('assets/images/flags/indonesia.svg') }}" alt="user-image" class="me-2 rounded" height="20">
